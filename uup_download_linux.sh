#!/bin/bash
#Generated on 2021-09-03 14:12:02 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=$BUILD&pack=$LANG&edition=$EDITION&aria2=2"
if [ $? != 0 ]; then
